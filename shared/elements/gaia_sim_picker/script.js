...
window.GaiaSimPicker = (function(win) {
  ...
  var baseurl = window.GaiaSimPickerBaseurl ||
    '/contacts/shared/elements/gaia_sim_picker/';
  ...
  proto.createdCallback = function() {
    ...
    LazyLoader.load(['/contacts/shared/js/component_utils.js'], function() {
  ...
  proto.getOrPick = function(defaultCardIndex,
    ...
    LazyLoader.load(['/contacts/shared/elements/gaia_menu/script.js'], function() {
